...
int main(int argc, char *argv[])
{
    ...
    int Left_matrix_x = atoi(argv[1]), Left_matrix_y = Left_matrix_x, Right_matrix_x = Left_matrix_x, Right_matrix_y = Left_matrix_x, Left_vector_size, Right_vector_size;
